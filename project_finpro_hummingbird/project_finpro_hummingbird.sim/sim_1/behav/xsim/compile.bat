...
REM
REM Generated by Vivado on Sun Dec 07 16:17:06 +0700 2025
...
echo "xvhdl --incr --relax -prj tb_StateCore_vhdl.prj"
call xvhdl  --incr --relax -prj tb_StateCore_vhdl.prj -log xvhdl.log
